...
class DominoMail(object):
    ...
    def __init__(self, config, servers):
        ...
        self.context = {'title': 'Domino Mail',
                        'now': self.now,
    ...
    def render(self):
        ...
        #myrender = Render(self.config.templatesPath(), 'domino-mail-html.tpl',
        #                  self.config.wwwRoot() + 'domino-mail.html')
        #myrender.render(self.context)
        myrender = Render(self.config.templatesPath(), 'json',
                          self.config.wwwRoot() + 'domino-mail.json')
        myrender.render(self.context)
